...
<div id="header">
	...
	<div id="global_nav">
			...
			if ( is_page( 'contact' ) ) {
				echo "class='current'";}
			?>
			><a href="http://www.louisvillehardcore.com/contact" title="Contact">Contact</a></li>
			<li><a href="http://forums.louisvillehardcore.com/" title="Forums">Forums</a></li>
			<!-- <li 
			<?php
			if ( $currentFile === 'products_page' ) {
				echo "class='current'";}
			?>
			><a href="http://www.louisvillehardcore.com/products-page/" title="About">Store</a></li> -->
			<li><a href="http://www.louisvillehardcore.com/flyers/" title="Flyers">Flyers</a></li>
			<li 
			<?php
			if ( $currentFile === 'shows' ) {
				echo "class='current'";}
			?>
			><a href="http://www.louisvillehardcore.com/shows" title="Louisville Punk, Hardcore, Indie Rock Underground Music Shows, Events, and Concerts">Shows</a></li>
			...
			if ( is_home() ) {
				echo ' id="current_nav"';}
			?>
			><a href="http://www.louisvillehardcore.com/" title="Blog">Blog</a></li>
			</ul>
	</div>
