		...
		<?php } ?>
			...
			<div class="archive__post-thumb">
				<?php if ( has_post_thumbnail( $post->ID ) ) : ?>
					...
					?>
				<img src="<?php echo $image; ?>" alt="Featured Image for <?php echo the_title(); ?>" height="350" width="350" class="archive__post-image">
				<?php else : ?>
					<img src="https://loremflickr.com/350/350" alt="Featured Image for <?php echo the_title(); ?>" height="350" width="350" class="archive__post-image">
			<?php endif; ?>
			</div>
			...
			<div class="archive__post-info">
				...
				<div class="entry">
					...
					<div class="archive__readmore-link">
						<a href="<?php echo the_permalink(); ?>" aria-label="Read the entire '<?php echo the_title(); ?>' article" class="align-right">Read More >></a>
					</div>
				</div>
